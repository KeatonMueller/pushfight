...
public class CoevolutionSplitRef {
     ...
     */
    public static double[] p1WeightsOld =
            {0.8445876921792111, 0.8970492450753385, 0.9080945965208406, 0.14852226490091258,
                    -0.2540021511646249, 0.4553156647079748, 0.10447428668541514};
    /**
     * Weights after 2 days of training for P1
     */
    public static double[] p2WeightsOld =
            {0.429423050881819, 0.7135061645010079, 0.3595997234686382, 0.5104436521900898,
                    0.27424875411762906, 0.7611561274508133, 0.8775339091415143};

    /**
     * Weights after 6 days of training for P1
     */
    public static double[] p1Weights = {0.5521080749697812, 0.5923223562499759, 0.4289637376549804,
            0.960514429066763, 0.11422172666289843, 0.9809774011640421, 0.9364107685012518};

    /**
     * Weights after 6 days of training for P2
     */
    public static double[] p2Weights = {0.08295565959195139, 0.5136740510802099, 0.6090830777207351,
            0.12032310259128409, 0.22044412021531157, 0.6569107416595015, 0.6438357433108626};
